...
| Jar                                              | Purpose                            |
|--------------------------------------------------|------------------------------------|
| `kronotop/target/kronotop-2026.06-1.jar`         | The server                         |
| `kronotop-cli/target/kronotop-cli-2026.06-1.jar` | Interactive command-line client    |
| `kronotop-ctl/target/kronotop-ctl-2026.06-1.jar` | Cluster control and bootstrap tool |
...
java --sun-misc-unsafe-memory-access=allow \
     ...
     -jar kronotop/target/kronotop-2026.06-1.jar
```
...
```
java -jar kronotop-ctl/target/kronotop-ctl-2026.06-1.jar bootstrap --primary BUCKET 127.0.0.1:3320=0
```
...
```
java -jar kronotop-ctl/target/kronotop-ctl-2026.06-1.jar bootstrap \
...
```
java -jar kronotop-cli/target/kronotop-cli-2026.06-1.jar -h 127.0.0.1 -p 5484
```
