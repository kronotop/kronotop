...
```bash
java -jar kronotop-benchmark-2026.07-2.jar bucket insert --host <HOST_B_PRIVATE_IP> --threads 50
java -jar kronotop-benchmark-2026.07-2.jar bucket query --host <HOST_B_PRIVATE_IP> --threads 50
java -jar kronotop-benchmark-2026.07-2.jar bucket mixed --host <HOST_B_PRIVATE_IP> --threads 50
java -jar kronotop-benchmark-2026.07-2.jar vector tweets --host <HOST_B_PRIVATE_IP> --threads 50
```
