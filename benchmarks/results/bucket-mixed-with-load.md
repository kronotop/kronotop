...
```
java -jar kronotop-benchmark/target/kronotop-benchmark-2026.07-1.jar bucket mixed --host 172.31.8.56 --total-ops 10000 --preload-docs 50000 --threads 50 --output-dir latencies
```
