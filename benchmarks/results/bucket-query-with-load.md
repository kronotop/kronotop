...
```
java -jar kronotop-benchmark/target/kronotop-benchmark-2026.06-1.jar bucket query --host 172.31.8.56 --total-docs 50000 --threads 50 --queries 50000 --output-dir latencies
```
