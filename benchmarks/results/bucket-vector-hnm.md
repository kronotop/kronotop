...
```
java -jar kronotop-benchmark/target/kronotop-benchmark-2026.07-2.jar vector hnm --host 172.31.8.56 --threads 8 --search-rounds 100 --top-k 10 --data-dir ~/Code/hnm-data/
```
