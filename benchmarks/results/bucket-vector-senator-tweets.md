...
```
java -jar kronotop-benchmark/target/kronotop-benchmark-2026.07-2.jar vector tweets --host 172.31.8.56 --threads 50 --search-rounds 100 --top-k 10 --data ~/senator-tweets/train.jsonl
