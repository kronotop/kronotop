...
```
cp kronotop/target/kronotop-2026.07-2.jar docker/kronotop.jar
cp kronotop-ctl/target/kronotop-ctl-2026.07-2.jar docker/kronotop-ctl.jar
cp kronotop-cli/target/kronotop-cli-2026.07-2.jar docker/kronotop-cli.jar
```
