...
```
cp kronotop/target/kronotop-2026.09-1.jar docker/kronotop.jar
cp kronotop-ctl/target/kronotop-ctl-2026.09-1.jar docker/kronotop-ctl.jar
cp kronotop-cli/target/kronotop-cli-2026.09-1.jar docker/kronotop-cli.jar
```
