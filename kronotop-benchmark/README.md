...
```bash
java -jar kronotop-benchmark/target/kronotop-benchmark-2026.08-1.jar vector tweets 
    --threads 8 
    --search-rounds 100 
    --top-k 10 
...
```bash
java -jar kronotop-benchmark/target/kronotop-benchmark-2026.08-1.jar vector tweets --threads 8 --skip-load --search-rounds 100 --top-k 10
...
```bash
java -jar kronotop-benchmark/target/kronotop-benchmark-2026.08-1.jar vector hnm --threads 8 --search-rounds 100 --top-k 10 --data-dir ~/Downloads/hnm
```

Results on Apple Silicon M4 Pro with 48GB of RAM:

```bash
java -jar kronotop-benchmark/target/kronotop-benchmark-2026.08-1.jar vector hnm --threads 8 --search-rounds 100 --top-k 10 --skip-load
