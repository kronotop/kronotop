...
class HelpFormatterTest {
    ...
    void shouldRenderNameUsageAndFields() {
        ...
        CommandDoc doc = new CommandDoc("BUCKET.QUERY", List.of("bucket", "query", "[LIMIT", "limit]"),
                "Queries documents.", "2026.06-1", "bucket");
        String expected = """
    ...
    void shouldReplaceNonBreakingSpaceInUsage() {
        ...
        CommandDoc doc = new CommandDoc("X", List.of("[SORTBY", "field", "ASC|DESC]", "a b"), "", "", "");
        assertEquals("\n  X [SORTBY field ASC|DESC] a b\n", HelpFormatter.format(doc, null));
    }
}
