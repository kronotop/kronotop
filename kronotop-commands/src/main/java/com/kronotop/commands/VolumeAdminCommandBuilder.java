...
public class VolumeAdminCommandBuilder<K, V> extends BaseKronotopCommandBuilder<K, V> {
    ...
    public Command<K, V, String> startReplication(String volumeName) {
        CommandArgs<K, V> args = new CommandArgs<>(codec)
    ...
    public Command<K, V, String> stopReplication(String volumeName) {
        CommandArgs<K, V> args = new CommandArgs<>(codec)
                .add(CommandKeyword.REPLICATION)
                .add("STOP")
                .add(volumeName);
    ...
    public Command<K, V, String> startVacuum(String volumeName, float garbageThreshold) {
        CommandArgs<K, V> args = new CommandArgs<>(codec)
                .add(CommandKeyword.VACUUM)
                .add("START")
                .add(volumeName)
                .add(garbageThreshold);
        return createCommand(CommandType.VOLUME_ADMIN, new StatusOutput<>(codec), args);
    }
    ...
    public Command<K, V, String> dropVacuum(String volumeName) {
        CommandArgs<K, V> args = new CommandArgs<>(codec)
                .add(CommandKeyword.VACUUM)
                .add("DROP")
                .add(volumeName);
    ...
    public Command<K, V, String> statusVacuum(String volumeName) {
        CommandArgs<K, V> args = new CommandArgs<>(codec)
                .add(CommandKeyword.VACUUM)
                .add("STATUS")
                .add(volumeName);
