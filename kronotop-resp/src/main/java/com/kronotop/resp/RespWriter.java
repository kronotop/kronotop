...
public class RespWriter {
    ...
    public void writeCommand(List<String> args) throws IOException {
        writeCommandNoFlush(args);
        output.flush();
    }

    /**
     * Writes a command without flushing. Use for pipelining multiple commands.
     */
    public void writeCommandNoFlush(List<String> args) throws IOException {
        // Write array header
        output.write('*');
