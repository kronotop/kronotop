...
public record IndexStatsTaskState(IndexTaskStatus status, String error) {
    ...
    public static IndexStatsTaskState load(Transaction tr, DirectorySubspace subspace, Versionstamp taskId) {
        ...
        return new IndexStatsTaskState(status, error);
    }
