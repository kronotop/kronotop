    ...
    public boolean test(BqlValue bqlValue) {
        ...
        return switch (this.operand()) {
            ...
            case Decimal128Val decimal128Val -> {
                ...
                yield FilterEvaluator.evaluateComparison(this.op(), actualDecimal128Val.value(), decimal128Val.value());
            }
            ...
            case VersionstampVal versionstampVal -> {
                ...
                yield FilterEvaluator.evaluateComparison(this.op(), actualVersionstampVal.value().getBytes(), versionstampVal.value().getBytes());
            }
