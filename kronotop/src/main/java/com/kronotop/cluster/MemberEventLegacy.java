...
public class MemberEventLegacy {
    private BroadcastEventKind type;
    ...
    public MemberEventLegacy(BroadcastEventKind type, String host, int port, Versionstamp processID, long createdAt) {
        this.type = type;
    ...
    public MemberEventLegacy(BroadcastEventKind type, String host, int port, Versionstamp processID) {
        this(type, host, port, processID, Instant.now().toEpochMilli());
    }

    public BroadcastEventKind getType() {
        return type;
    }
