...
public class InternalClient {
    ...
    public static StatefulInternalConnection<String, String> connect(RedisClusterClient client) {
        StatefulRedisClusterConnection<String, String> connection = client.connect();
        return new StatefulInternalConnection<>(connection, StringCodec.UTF8);
    }

    public static <K, V> StatefulInternalConnection<K, V> connect(RedisClusterClient client, RedisCodec<K, V> codec) {
