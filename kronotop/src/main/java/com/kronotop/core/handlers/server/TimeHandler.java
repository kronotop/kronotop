...
public class TimeHandler implements Handler {
    ...
    public void beforeExecute(Request request) {
        request.attr(MessageTypes.TIME).set(new TimeMessage());
    }
    ...
    public void execute(Request request, Response response) {
        ...
        List<RedisMessage> result = List.of(
                bulkString(Long.toString(seconds)),
                bulkString(Long.toString(microseconds))
        );
