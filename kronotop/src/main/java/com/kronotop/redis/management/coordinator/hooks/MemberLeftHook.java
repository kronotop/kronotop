...
public class MemberLeftHook implements BroadcastEventHook {
    private static final Logger LOGGER = LoggerFactory.getLogger(MemberLeftHook.class);

    private final RedisCoordinator coordinator;

    public MemberLeftHook(RedisCoordinator coordinator) {
    ...
    public void run(BroadcastEvent event) {
        ...
        LOGGER.info("Redis MemberLeftHook running");
    }
}
