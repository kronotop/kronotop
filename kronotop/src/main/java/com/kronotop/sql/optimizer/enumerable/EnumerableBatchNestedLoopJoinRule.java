...
public class EnumerableBatchNestedLoopJoinRule
    ...
    public interface Config extends RelRule.Config {
        Config DEFAULT = ImmutableEnumerableBatchNestedLoopJoinRule.Config.builder()
                .operandSupplier(b -> b.operand(LogicalJoin.class).anyInputs())
                .description("EnumerableBatchNestedLoopJoinRule").build();
