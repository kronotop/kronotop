...
public class EnumerableFilterToCalcRule
    ...
    public interface Config extends RelRule.Config {
        Config DEFAULT = ImmutableEnumerableFilterToCalcRule.Config.builder()
                .operandSupplier(b ->
                        b.operand(EnumerableFilter.class).anyInputs()).build();

        @Override
        default EnumerableFilterToCalcRule toRule() {
