...
/**
 * Implementation of {@link Match} in
...
public class EnumerableMatch extends Match implements EnumerableRel {
    ...
    private static Expression implementPredicate(PhysType physType,
        ...
        if (EnumerableRules.BRIDGE_METHODS) {
            ...
            @SuppressWarnings("unused") final ParameterExpression rowsO_ =
        ...
        return Expressions.new_(Types.of(Predicate.class), EnumUtils.NO_EXPRS,
                memberDeclarations);
    }
    ...
    private Expression implementEmitter(EnumerableRelImplementor implementor,
        ...
        return Expressions.new_(
                Types.of(Enumerables.Emitter.class), EnumUtils.NO_EXPRS,
                Expressions.list(
                        EnumUtils.overridingMethodDecl(
