...
/**
 * Rule to convert a {@link LogicalSort} on top of a
 * {@link LogicalUnion} into a {@link EnumerableMergeUnion}.
 *
...
public class EnumerableMergeUnionRule extends RelRule<EnumerableMergeUnionRule.Config> {
    ...
    public interface Config extends RelRule.Config {
        Config DEFAULT_CONFIG = ImmutableEnumerableMergeUnionRule.Config.builder()
                .description("EnumerableMergeUnionRule").operandSupplier(
                        b0 -> b0.operand(LogicalSort.class).oneInput(
                                b1 -> b1.operand(LogicalUnion.class).anyInputs())).build();
