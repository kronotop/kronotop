...
/**
 * Variant of {@link ProjectToCalcRule} for
...
public class EnumerableProjectToCalcRule extends ProjectToCalcRule {
    ...
    public interface Config extends ProjectToCalcRule.Config {
        Config DEFAULT = ImmutableEnumerableProjectToCalcRule.Config.builder()
                .operandSupplier(b ->
                        b.operand(EnumerableProject.class).anyInputs()).build();
