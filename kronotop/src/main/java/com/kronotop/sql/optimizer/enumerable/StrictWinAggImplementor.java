 ...
 *
 * @see RexImpTable.FirstLastValueImplementor
 * @see RexImpTable.RankImplementor
 * @see RexImpTable.RowNumberImplementor
 */
public abstract class StrictWinAggImplementor extends StrictAggImplementor
    ...
    @Override
    protected final void implementNotNullAdd(AggContext info,
                                             AggAddContext add) {
