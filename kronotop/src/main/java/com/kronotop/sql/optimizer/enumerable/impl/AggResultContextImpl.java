...
import com.kronotop.sql.optimizer.enumerable.AggResultContext;
import com.kronotop.sql.optimizer.enumerable.PhysType;
...
public class AggResultContextImpl extends AggResetContextImpl
    ...
    @Override
    public @Nullable Expression key() {
        return key;
    }
    ...
    @Override
    public RexToLixTranslator resultTranslator() {
