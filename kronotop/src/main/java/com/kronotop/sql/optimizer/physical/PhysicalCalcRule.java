...
/**
 * Rule to convert a {@link LogicalCalc} to an {@link PhysicalCalc}.
 * You may provide a custom config to convert other nodes that extend {@link Calc}.
 *
 * @see PhysicalRules#PHYSICAL_CALC_RULE
 */
@Value.Enclosing
class PhysicalCalcRule extends ConverterRule {
    /**
    ...
    public static final Config DEFAULT_CONFIG = Config.INSTANCE
            ...
            .withConversion(LogicalCalc.class, RelOptUtil::notContainsWindowedAgg,
                    Convention.NONE, PhysicalConvention.INSTANCE,
                    "PhysicalCalcRule")
            .withRuleFactory(PhysicalCalcRule::new);

    protected PhysicalCalcRule(Config config) {
        super(config);
    }
