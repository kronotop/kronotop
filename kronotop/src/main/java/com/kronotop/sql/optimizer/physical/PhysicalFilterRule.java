...
/**
 * Rule to convert a {@link LogicalFilter} to an {@link PhysicalFilter}.
 * You may provide a custom config to convert other nodes that extend {@link Filter}.
 *
 * @see PhysicalRules#PHYSICAL_FILTER_RULE
 */
class PhysicalFilterRule extends ConverterRule {
    /**
    ...
    public RelNode convert(RelNode rel) {
        ...
        return new PhysicalFilter(rel.getCluster(),
