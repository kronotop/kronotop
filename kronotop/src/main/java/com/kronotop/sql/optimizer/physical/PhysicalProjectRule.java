...
/**
 * Rule to convert a {@link LogicalProject} to an {@link PhysicalProject}.
 * You may provide a custom config to convert other nodes that extend {@link Project}.
 *
 * @see PhysicalRules#PHYSICAL_PROJECT_RULE
 */
class PhysicalProjectRule extends ConverterRule {
    /**
