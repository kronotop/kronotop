...
/**
 * Planner rule that converts a {@link LogicalTableScan} to an {@link PhysicalTableScan}.
 * You may provide a custom config to convert other nodes that extend {@link TableScan}.
 *
 * @see PhysicalRules#PHYSICAL_TABLE_SCAN_RULE
 */
public class PhysicalTableScanRule extends ConverterRule {
    ...
    public @Nullable RelNode convert(RelNode rel) {
        ...
        return PhysicalTableScan.create(scan.getCluster(), relOptTable);
    }
}
