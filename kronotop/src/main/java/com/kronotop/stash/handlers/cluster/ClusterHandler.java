...
package com.kronotop.stash.handlers.cluster;
...
import com.kronotop.stash.handlers.cluster.protocol.ClusterSubcommand;
...
public class ClusterHandler extends BaseHandler implements Handler {
    ...
    public ClusterHandler(StashService service) {
        super(service);
