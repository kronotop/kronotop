...
import com.kronotop.stash.handlers.hash.protocol.HRandFieldMessage;
...
public class HRandFieldHandler extends BaseHandler implements Handler {
    ...
    public HRandFieldHandler(StashService service) {
        super(service);
        random = new Random();
    }
    ...
    public void execute(Request request, Response response) throws Exception {
        ...
        StashShard shard = service.findShard(hrandfieldMessage.getKey(), ShardStatus.READONLY);
