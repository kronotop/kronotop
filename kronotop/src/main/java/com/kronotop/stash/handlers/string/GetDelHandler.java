...
public class GetDelHandler extends BaseStringHandler implements Handler {
    ...
    private StashValueContainer executeGetDelCommand(StashShard shard, GetDelMessage message) {
    ...
    public void execute(Request request, Response response) {
        ...
        StashShard shard = service.findShard(getDelMessage.getKey(), ShardStatus.READWRITE);
