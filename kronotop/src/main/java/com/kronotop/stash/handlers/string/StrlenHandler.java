...
public class StrlenHandler extends BaseStringHandler implements Handler {
    ...
    public void execute(Request request, Response response) {
        ...
        StashShard shard = service.findShard(strlenMessage.getKey(), ShardStatus.READONLY);
        StashValueContainer container;
        ...
        checkStashValueKind(container, StashValueKind.STRING);
