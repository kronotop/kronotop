 ...
 */
public interface StashShard extends Shard {

    /**
     * Provides access to the storage map which is used to hold Stash values.
     *
     * @return a ConcurrentMap where keys are strings representing Stash keys and values
     * are StashValueContainer objects representing the stored Stash values.
     */
    ConcurrentMap<String, StashValueContainer> storage();
