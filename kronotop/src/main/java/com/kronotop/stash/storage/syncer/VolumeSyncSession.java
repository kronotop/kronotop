...
/**
 * Manages a batch of Stash data structure writes and deletes to Volume storage within a single
...
public class VolumeSyncSession {
    ...
    public VolumeSyncSession(Context context, StashShard shard, Prefix prefix) {
        this.context = context;
        this.shard = shard;
        this.versionstampedKeys = new ArrayList<>();
