...
/**
 * Synchronizes Stash data structures to Volume storage by processing queued sync jobs.
 *
 ...
 * @see VolumeSyncJob
 * @see StashShard#volumeSyncQueue()
 */
public class VolumeSyncer {
     ...
     * @param shard   the Stash shard to synchronize volume data for.
     */
    public VolumeSyncer(Context context, StashShard shard) {
