...
package com.kronotop.stash.storage.syncer.jobs;

import com.apple.foundationdb.tuple.Versionstamp;
import com.kronotop.stash.storage.StashValueContainer;
import com.kronotop.stash.storage.syncer.VolumeSyncSession;
...
public class BaseJob {
    ...
    protected void linkRedisValueWithVolumeEntry(VolumeSyncSession session, String key, int position, BiConsumer<StashValueContainer, Versionstamp> syncFunction) {
        ...
        lock.writeLock().lock();
        try {
            StashValueContainer container = session.shard().storage().get(key);
