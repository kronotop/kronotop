...
public class ReplicationSlot {
    ...
    /**
     * Computes and updates a replication slot based on the given transaction, replication configuration,
     * slot identifier, and a remapping function. If the replication slot does not exist, an exception is thrown.
