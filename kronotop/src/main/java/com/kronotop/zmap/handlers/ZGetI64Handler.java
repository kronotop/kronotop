...
import com.kronotop.zmap.handlers.protocol.ZGetI64Message;
...
public class ZGetI64Handler extends BaseZMapHandler implements Handler {
    public ZGetI64Handler(ZMapService service) {
        super(service);
    }
