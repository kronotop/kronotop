...
class HistogramUtilTest {
    ...
    void shouldBuildEmptyHistogramForEmptyInput() {
        ...
        Histogram histogram = HistogramUtil.buildHistogram(values);
    ...
    void shouldReturnNullForFindBucketWithEmptyBuckets() {
        ...
        HistogramBucket result = HistogramUtil.findBucket(histogram, value);
    ...
    void shouldFindBucketForValueInRange() {
        ...
        HistogramBucket result = HistogramUtil.findBucket(histogram, searchValue);
    ...
    void shouldReturnZeroPercentileForEmptyBuckets() {
        ...
        double percentile = HistogramUtil.findPercentile(histogram, value);
    ...
    void shouldReturnZeroPercentileForValueBelowRange() {
        ...
        double percentile = HistogramUtil.findPercentile(histogram, searchValue);
