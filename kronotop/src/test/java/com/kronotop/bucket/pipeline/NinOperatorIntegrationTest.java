...
class NinOperatorIntegrationTest extends BasePipelineTest {
    ...
    void shouldMatchDocumentsWithNinOperator() {
        ...
        PlanWithParams planWithParams = createPlanWithParams(metadata, "{'role': {'$nin': ['admin', 'editor']}}");
    ...
    void shouldMatchDocumentsWithNinOperatorWithIndex() {
        ...
        assertInstanceOf(TransformWithResidualPredicateNode.class, planWithParams.plan().next());
        QueryOptions config = QueryOptions.builder().build();
        QueryContext ctx = new QueryContext(getSession(), metadata, config, planWithParams.plan(), planWithParams.parameters());
    ...
    void shouldMatchMixedTypeDocumentsWithMixedTypeNinQuery() {
        ...
        PlanWithParams planWithParams = createPlanWithParams(metadata, "{'role': {'$nin': ['admin', 'editor', 3]}}");
        assertInstanceOf(FullScanNode.class, planWithParams.plan());
        QueryOptions config = QueryOptions.builder().build();
        QueryContext ctx = new QueryContext(getSession(), metadata, config, planWithParams.plan(), planWithParams.parameters());
    ...
    void shouldMatchDocumentsWithMixedTypesNinOperator() {
        ...
        PlanWithParams planWithParams = createPlanWithParams(metadata, "{'role': {'$nin': ['admin', 'editor', 20]}}");
        assertInstanceOf(FullScanNode.class, planWithParams.plan());
        QueryOptions config = QueryOptions.builder().build();
        QueryContext ctx = new QueryContext(getSession(), metadata, config, planWithParams.plan(), planWithParams.parameters());
    ...
    void shouldMatchSingleValueNin() {
        ...
        PlanWithParams planWithParams = createPlanWithParams(metadata, "{'role': {'$nin': ['admin']}}");
        assertInstanceOf(FullScanNode.class, planWithParams.plan());
        QueryOptions config = QueryOptions.builder().build();
        QueryContext ctx = new QueryContext(getSession(), metadata, config, planWithParams.plan(), planWithParams.parameters());
    ...
    void shouldMatchAllDocumentsWhenValuesNotPresent() {
        ...
        PlanWithParams planWithParams = createPlanWithParams(metadata, "{'role': {'$nin': ['superuser', 'guest']}}");
        assertInstanceOf(FullScanNode.class, planWithParams.plan());
        QueryOptions config = QueryOptions.builder().build();
        QueryContext ctx = new QueryContext(getSession(), metadata, config, planWithParams.plan(), planWithParams.parameters());
    ...
    void shouldReturnAllForEmptyNin() {
        ...
        PlanWithParams planWithParams = createPlanWithParams(metadata, "{'role': {'$nin': []}}");
        assertInstanceOf(FullScanNode.class, planWithParams.plan());
        QueryOptions config = QueryOptions.builder().build();
        QueryContext ctx = new QueryContext(getSession(), metadata, config, planWithParams.plan(), planWithParams.parameters());
    ...
    void shouldExcludeNullInNinList() {
        ...
        PlanWithParams planWithParams = createPlanWithParams(metadata, "{'role': {'$nin': [null, 'admin']}}");
        assertInstanceOf(FullScanNode.class, planWithParams.plan());
        QueryOptions config = QueryOptions.builder().build();
        QueryContext ctx = new QueryContext(getSession(), metadata, config, planWithParams.plan(), planWithParams.parameters());
    ...
    void shouldHandleNinOnNestedField() {
        ...
        PlanWithParams planWithParams = createPlanWithParams(metadata, "{'user.role': {'$nin': ['admin', 'editor']}}");
        assertInstanceOf(FullScanNode.class, planWithParams.plan());
        QueryOptions config = QueryOptions.builder().build();
        QueryContext ctx = new QueryContext(getSession(), metadata, config, planWithParams.plan(), planWithParams.parameters());
    ...
    void shouldHandleNinWithNumericTypes() {
        ...
        PlanWithParams planWithParams = createPlanWithParams(metadata, "{'age': {'$nin': [25, 35]}}");
        assertInstanceOf(IndexScanNode.class, planWithParams.plan());
        QueryOptions config = QueryOptions.builder().build();
        QueryContext ctx = new QueryContext(getSession(), metadata, config, planWithParams.plan(), planWithParams.parameters());
    ...
    void shouldHandleDuplicateValuesInNinList() {
        ...
        PlanWithParams planWithParams = createPlanWithParams(metadata, "{'role': {'$nin': ['admin', 'admin', 'editor']}}");
        assertInstanceOf(IndexScanNode.class, planWithParams.plan());
        QueryOptions config = QueryOptions.builder().build();
        QueryContext ctx = new QueryContext(getSession(), metadata, config, planWithParams.plan(), planWithParams.parameters());
    ...
    void shouldMatchArrayFieldWithNinOperator() {
        ...
        PlanWithParams planWithParams = createPlanWithParams(metadata, "{'tags': {'$nin': ['python', 'rust']}}");
        assertInstanceOf(FullScanNode.class, planWithParams.plan());
        QueryOptions config = QueryOptions.builder().build();
        QueryContext ctx = new QueryContext(getSession(), metadata, config, planWithParams.plan(), planWithParams.parameters());
    ...
    void shouldMatchDocumentsWithMissingField() {
        ...
        PlanWithParams planWithParams = createPlanWithParams(metadata, "{'role': {'$nin': ['admin', 'user']}}");
        assertInstanceOf(FullScanNode.class, planWithParams.plan());
        QueryOptions config = QueryOptions.builder().build();
        QueryContext ctx = new QueryContext(getSession(), metadata, config, planWithParams.plan(), planWithParams.parameters());
    ...
    void shouldExcludeNestedArrayAsTopLevelElement() {
        ...
        PlanWithParams planWithParams = createPlanWithParams(metadata, "{'tags': {'$nin': [['A', 'B']]}}");
        assertInstanceOf(FullScanNode.class, planWithParams.plan());
        QueryOptions config = QueryOptions.builder().build();
        QueryContext ctx = new QueryContext(getSession(), metadata, config, planWithParams.plan(), planWithParams.parameters());
    ...
    void shouldNotExcludeScalarInsideNestedArray() {
        ...
        PlanWithParams planWithParams = createPlanWithParams(metadata, "{'tags': {'$nin': ['A']}}");
        assertInstanceOf(FullScanNode.class, planWithParams.plan());
        QueryOptions config = QueryOptions.builder().build();
        QueryContext ctx = new QueryContext(getSession(), metadata, config, planWithParams.plan(), planWithParams.parameters());
    ...
    void shouldExcludeTopLevelScalarInMixedArray() {
        ...
        PlanWithParams planWithParams = createPlanWithParams(metadata, "{'tags': {'$nin': ['C']}}");
        assertInstanceOf(FullScanNode.class, planWithParams.plan());
        QueryOptions config = QueryOptions.builder().build();
        QueryContext ctx = new QueryContext(getSession(), metadata, config, planWithParams.plan(), planWithParams.parameters());
    ...
    void shouldFallbackToFullScanForSingleValueNinOnMultiKeyIndex() {
        ...
        PlanWithParams planWithParams = createPlanWithParams(metadata, "{'tags': {'$nin': ['python']}}");
        assertInstanceOf(FullScanNode.class, planWithParams.plan());
        QueryOptions config = QueryOptions.builder().build();
        QueryContext ctx = new QueryContext(getSession(), metadata, config, planWithParams.plan(), planWithParams.parameters());
    ...
    void shouldFallbackToFullScanForNinOnIntMultiKeyIndex() {
        ...
        // Multi-key index: falls back to FullScan for correct array semantics
        PlanWithParams planWithParams = createPlanWithParams(metadata, "{'scores': {'$nin': [90, 70]}}");
        assertInstanceOf(FullScanNode.class, planWithParams.plan());
        QueryOptions config = QueryOptions.builder().build();
        QueryContext ctx = new QueryContext(getSession(), metadata, config, planWithParams.plan(), planWithParams.parameters());
    ...
    @Test
    void shouldExcludeDocumentsWithNinOperatorOnId() {
        // Behavior: $nin on _id excludes documents whose ObjectId is in the operand list.
        final String TEST_BUCKET_NAME = "test-bucket-nin-operator-on-id";
