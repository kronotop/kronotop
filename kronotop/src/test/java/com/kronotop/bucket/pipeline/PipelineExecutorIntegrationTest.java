...
class PipelineExecutorIntegrationTest extends BasePipelineTest {
    ...
    void testRangeScanNodeWithNullValues_NULL_Boundaries() {
        ...
        PipelineExecutor executor = createPipelineExecutorForQuery(metadata, "{ 'age': { '$gt': null, '$lt': null } }");
        PipelineContext ctx = createPipelineContext(metadata);
    ...
    void testRangeScanNodeNonsenseQuery() {
        ...
        PipelineExecutor executor = createPipelineExecutorForQuery(metadata, "{ 'age': { '$ne': null, '$eq': null } }");
        PipelineContext ctx = createPipelineContext(metadata);
    ...
    void testContradictionShouldReturnEmptyResult() {
        ...
        PipelineExecutor executor = createPipelineExecutorForQuery(metadata, "{ 'name': { '$eq': 'A', '$eq': 'B' } }");
        PipelineContext ctx = createPipelineContext(metadata);
