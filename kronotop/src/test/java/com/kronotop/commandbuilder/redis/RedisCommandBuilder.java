 ...
 */
package com.kronotop.commandbuilder.redis;
...
public class RedisCommandBuilder<K, V> extends BaseRedisCommandBuilder<K, V> {
    ...
    public Command<K, V, Long> aclDeluser(String... usernames) {
        notEmpty(usernames);
        CommandArgs<K, V> args = new CommandArgs<>(codec);
        args.add(DELUSER);
    ...
    public Command<K, V, String> aclDryRun(String username, String command, String... commandArgs) {
    ...
    public Command<K, V, String> aclDryRun(String username, RedisCommand<K, V, ?> command) {
        LettuceAssert.notNull(username, "username " + MUST_NOT_BE_NULL);
        LettuceAssert.notNull(command, "command " + MUST_NOT_BE_NULL);
    ...
    public Command<K, V, String> aclGenpass() {
        CommandArgs<K, V> args = new CommandArgs<>(codec);
        args.add(GENPASS);
        return createCommand(ACL, new StatusOutput<>(codec), args);
    }

    public Command<K, V, String> aclGenpass(int bits) {
        CommandArgs<K, V> args = new CommandArgs<>(codec);
        args.add(GENPASS).add(bits);
        return createCommand(ACL, new StatusOutput<>(codec), args);
    }

    public Command<K, V, List<Object>> aclGetuser(String username) {
        LettuceAssert.notNull(username, "Username " + MUST_NOT_BE_NULL);
        CommandArgs<K, V> args = new CommandArgs<>(codec);
    ...
    public Command<K, V, List<String>> aclList() {
        CommandArgs<K, V> args = new CommandArgs<>(codec);
        args.add(LIST);
        return createCommand(ACL, new StringListOutput<>(codec), args);
    }

    public Command<K, V, String> aclLoad() {
        CommandArgs<K, V> args = new CommandArgs<>(codec);
        args.add(LOAD);
        return createCommand(ACL, new StatusOutput<>(codec), args);
    }

    public Command<K, V, List<Map<String, Object>>> aclLog() {
        CommandArgs<K, V> args = new CommandArgs<>(codec);
        args.add(LOG);
        return new Command(ACL, new ListOfGenericMapsOutput<>(StringCodec.ASCII), args);
    }

    public Command<K, V, List<Map<String, Object>>> aclLog(int count) {
        CommandArgs<K, V> args = new CommandArgs<>(codec);
        args.add(LOG).add(count);
        return new Command(ACL, new ListOfGenericMapsOutput<>(StringCodec.ASCII), args);
    }

    public Command<K, V, String> aclLogReset() {
        CommandArgs<K, V> args = new CommandArgs<>(codec);
        args.add(LOG).add(RESET);
        return createCommand(ACL, new StatusOutput<>(codec), args);
    }

    public Command<K, V, String> aclSave() {
        CommandArgs<K, V> args = new CommandArgs<>(codec);
        args.add(CommandKeyword.SAVE);
        return createCommand(ACL, new StatusOutput<>(codec), args);
    }

    public Command<K, V, String> aclSetuser(String username, AclSetuserArgs setuserArgs) {
        notNullKey(username);
        CommandArgs<K, V> args = new CommandArgs<>(codec);
    ...
    public Command<K, V, List<String>> aclUsers() {
        CommandArgs<K, V> args = new CommandArgs<>(codec);
        args.add(USERS);
        return createCommand(ACL, new StringListOutput<>(codec), args);
    }

    public Command<K, V, String> aclWhoami() {
        CommandArgs<K, V> args = new CommandArgs<>(codec);
        args.add(WHOAMI);
        return createCommand(ACL, new StatusOutput<>(codec), args);
    }
    ...
    public Command<K, V, String> auth(CharSequence password) {
    ...
    public Command<K, V, String> auth(String username, CharSequence password) {
        LettuceAssert.notNull(username, "Username " + MUST_NOT_BE_NULL);
    ...
    public Command<K, V, String> auth(String username, char[] password) {
        LettuceAssert.notNull(username, "Username " + MUST_NOT_BE_NULL);
        LettuceAssert.isTrue(!username.isEmpty(), "Username " + MUST_NOT_BE_EMPTY);
        LettuceAssert.notNull(password, "Password " + MUST_NOT_BE_NULL);
    ...
    public Command<K, V, Long> bitpos(K key, boolean state, long start) {
        notNullKey(key);
    ...
    public Command<K, V, V> blmove(K source, K destination, LMoveArgs lMoveArgs, long timeout) {
        LettuceAssert.notNull(source, "Source " + MUST_NOT_BE_NULL);
        LettuceAssert.notNull(destination, "Destination " + MUST_NOT_BE_NULL);
    ...
    public Command<K, V, V> blmove(K source, K destination, LMoveArgs lMoveArgs, double timeout) {
        LettuceAssert.notNull(source, "Source " + MUST_NOT_BE_NULL);
        LettuceAssert.notNull(destination, "Destination " + MUST_NOT_BE_NULL);
        LettuceAssert.notNull(lMoveArgs, "LMoveArgs " + MUST_NOT_BE_NULL);
    ...
    public Command<K, V, KeyValue<K, List<V>>> blmpop(long timeout, LMPopArgs lmPopArgs, K... keys) {
        LettuceAssert.notNull(keys, "Keys " + MUST_NOT_BE_NULL);
    ...
    public Command<K, V, KeyValue<K, List<V>>> blmpop(double timeout, LMPopArgs lmPopArgs, K... keys) {
        LettuceAssert.notNull(keys, "Keys " + MUST_NOT_BE_NULL);
        LettuceAssert.notNull(lmPopArgs, "LMPopArgs " + MUST_NOT_BE_NULL);
    ...
    public Command<K, V, KeyValue<K, V>> blpop(double timeout, K... keys) {
        notEmpty(keys);
    ...
    public Command<K, V, KeyValue<K, V>> brpop(double timeout, K... keys) {
        notEmpty(keys);
    ...
    public Command<K, V, V> brpoplpush(double timeout, K source, K destination) {
        LettuceAssert.notNull(source, "Source " + MUST_NOT_BE_NULL);
        LettuceAssert.notNull(destination, "Destination " + MUST_NOT_BE_NULL);
    ...
    public Command<K, V, String> clientCaching(boolean enabled) {
    ...
    public Command<K, V, Long> clientGetredir() {
    ...
    public Command<K, V, String> clientNoEvict(boolean on) {
        CommandArgs<K, V> args = new CommandArgs<>(codec).add("NO-EVICT").add(on ? ON : OFF);
        return createCommand(CLIENT, new StatusOutput<>(codec), args);
    }

    public Command<K, V, Long> clientId() {
    ...
    public Command<K, V, String> clientTracking(TrackingArgs trackingArgs) {
    ...
    public Command<K, V, Long> clientUnblock(long id, UnblockType type) {
    ...
    public Command<K, V, String> clusterAddSlotsRange(Range<Integer>... ranges) {
    ...
    public Command<K, V, String> clusterDelSlotsRange(Range<Integer>... ranges) {
        notEmptyRanges(ranges);
    ...
    public Command<K, V, String> clusterFailover(boolean force, boolean takeOver) {
    ...
    public Command<K, V, List<String>> clusterReplicas(String nodeId) {
        assertNodeId(nodeId);
    ...
    public Command<K, V, List<Object>> clusterShards() {
    ...
    public Command<K, V, Map<String, String>> configGet(String... parameters) {
    ...
    public Command<K, V, String> configSet(Map<String, String> configValues) {
    ...
    public <T> Command<K, V, T> eval(byte[] script, ScriptOutputType type, K[] keys, V... values) {
        return eval(script, type, false, keys, values);
    }

    public <T> Command<K, V, T> eval(byte[] script, ScriptOutputType type, boolean readonly, K[] keys, V... values) {
    ...
    public <T> Command<K, V, T> evalsha(String digest, ScriptOutputType type, boolean readonly, K[] keys, V... values) {
    ...
    public Command<K, V, String> exec() {
        return createCommand(EXEC, new StatusOutput<>(codec));
    }
    ...
    public Command<K, V, Boolean> expire(K key, long seconds, ExpireArgs expireArgs) {
        notNullKey(key);
    ...
    public Command<K, V, List<Long>> hexpire(K key, long seconds, ExpireArgs expireArgs, K... fields) {
    ...
    public Command<K, V, List<Long>> hexpireat(K key, long seconds, ExpireArgs expireArgs, K... fields) {
        keyAndFieldsProvided(key, fields);
    ...
    public Command<K, V, List<Long>> httl(K key, K... fields) {
        keyAndFieldsProvided(key, fields);
    ...
    public Command<K, V, List<Long>> hpexpire(K key, long milliseconds, ExpireArgs expireArgs, K... fields) {
        keyAndFieldsProvided(key, fields);
    ...
    public Command<K, V, List<Long>> hpexpireat(K key, long timestamp, ExpireArgs expireArgs, K... fields) {
        keyAndFieldsProvided(key, fields);
    ...
    public Command<K, V, List<Long>> hpexpiretime(K key, K... fields) {
        keyAndFieldsProvided(key, fields);
    ...
    public Command<K, V, List<Long>> hpttl(K key, K... fields) {
        keyAndFieldsProvided(key, fields);
    ...
    public Command<K, V, Boolean> expireat(K key, long timestamp, ExpireArgs expireArgs) {
        notNullKey(key);
    ...
    public Command<K, V, Long> expiretime(K key) {
        notNullKey(key);
    ...
    public Command<K, V, List<Long>> hexpiretime(K key, K... fields) {
        notNullKey(key);
    ...
    public Command<K, V, String> flushall(FlushMode flushMode) {
    ...
    public Command<K, V, String> flushdb(FlushMode flushMode) {
        LettuceAssert.notNull(flushMode, "FlushMode " + MUST_NOT_BE_NULL);

        return createCommand(FLUSHDB, new StatusOutput<>(codec), new CommandArgs<>(codec).add(flushMode));
    }

    public <T> Command<K, V, T> fcall(String function, ScriptOutputType type, boolean readonly, K[] keys, V... values) {
    ...
    public Command<K, V, String> functionLoad(byte[] functionCode, boolean replace) {
    ...
    public Command<K, V, byte[]> functionDump() {
        return createCommand(FUNCTION, new ByteArrayOutput<>(codec), new CommandArgs<>(codec).add(DUMP));
    }

    public Command<K, V, String> functionRestore(byte dump[], FunctionRestoreMode mode) {
    ...
    public Command<K, V, String> functionFlush(FlushMode mode) {
    ...
    public Command<K, V, String> functionKill() {
        return createCommand(FUNCTION, new StatusOutput<>(codec), new CommandArgs<>(codec).add(KILL));
    }

    public Command<K, V, List<Map<String, Object>>> functionList(String pattern) {
    ...
    public Command<K, V, Long> geoadd(K key, double longitude, double latitude, V member, GeoAddArgs geoArgs) {
        notNullKey(key);
    ...
    public Command<K, V, Long> geoadd(K key, Object[] lngLatMember, GeoAddArgs geoArgs) {
    ...
    public Command<K, V, Long> geoadd(K key, GeoValue<V>[] values, GeoAddArgs geoArgs) {
    ...
    public Command<K, V, List<GeoWithin<V>>> georadiusbymember(CommandType commandType, K key, V member, double distance, String unit,
                                                               GeoArgs geoArgs) {
    ...
    public Command<K, V, Set<V>> geosearch(K key, GeoSearch.GeoRef<K> reference, GeoSearch.GeoPredicate predicate) {
        notNullKey(key);
    ...
    public Command<K, V, List<GeoWithin<V>>> geosearch(K key, GeoSearch.GeoRef<K> reference, GeoSearch.GeoPredicate predicate,
                                                       GeoArgs geoArgs) {
        notNullKey(key);
        LettuceAssert.notNull(reference, "GeoRef " + MUST_NOT_BE_NULL);
        LettuceAssert.notNull(predicate, "GeoPredicate " + MUST_NOT_BE_NULL);
    ...
    public Command<K, V, Long> geosearchstore(K destination, K key, GeoSearch.GeoRef<K> reference, GeoSearch.GeoPredicate predicate,
    ...
    public Command<K, V, List<KeyValue<K, V>>> hgetallKeyValue(K key) {
        notNullKey(key);
    ...
    public Command<K, V, K> hrandfield(K key) {
        notNullKey(key);
    ...
    public Command<K, V, List<K>> hrandfield(K key, long count) {
        notNullKey(key);
    ...
    public Command<K, V, KeyValue<K, V>> hrandfieldWithvalues(K key) {
        notNullKey(key);
    ...
    public Command<K, V, List<KeyValue<K, V>>> hrandfieldWithvalues(K key, long count) {
        notNullKey(key);
    ...
    public Command<K, V, KeyScanCursor<K>> hscanNovalues(K key) {
        notNullKey(key);
    ...
    public Command<K, V, KeyScanCursor<K>> hscanNovalues(K key, ScanCursor scanCursor) {
        notNullKey(key);
    ...
    public Command<K, V, KeyScanCursor<K>> hscanNovalues(K key, ScanArgs scanArgs) {
        notNullKey(key);
    ...
    public Command<K, V, KeyScanCursor<K>> hscanNovalues(K key, ScanCursor scanCursor, ScanArgs scanArgs) {
        notNullKey(key);
    ...
    public Command<K, V, StreamScanCursor> hscanNoValuesStreaming(KeyStreamingChannel<K> channel, K key) {
        notNullKey(key);
        notNull(channel);
    ...
    public Command<K, V, StreamScanCursor> hscanNoValuesStreaming(KeyStreamingChannel<K> channel, K key, ScanCursor scanCursor) {
        notNullKey(key);
        notNull(channel);
    ...
    public Command<K, V, StreamScanCursor> hscanNoValuesStreaming(KeyStreamingChannel<K> channel, K key, ScanArgs scanArgs) {
        notNullKey(key);
        notNull(channel);
    ...
    public Command<K, V, V> lmove(K source, K destination, LMoveArgs lMoveArgs) {
        LettuceAssert.notNull(source, "Source " + MUST_NOT_BE_NULL);
        LettuceAssert.notNull(destination, "Destination " + MUST_NOT_BE_NULL);
        LettuceAssert.notNull(lMoveArgs, "LMoveArgs " + MUST_NOT_BE_NULL);
    ...
    public Command<K, V, KeyValue<K, List<V>>> lmpop(LMPopArgs lmPopArgs, K... keys) {
        LettuceAssert.notNull(keys, "Keys " + MUST_NOT_BE_NULL);
        LettuceAssert.notNull(lmPopArgs, "LMPopArgs " + MUST_NOT_BE_NULL);
    ...
    public Command<K, V, Long> lpos(K key, V value, LPosArgs lposArgs) {
        notNullKey(key);
    ...
    public Command<K, V, List<Long>> lpos(K key, V value, long count, LPosArgs lposArgs) {
        notNullKey(key);
    ...
    public Command<K, V, Long> memoryUsage(K key) {
    ...
    public Command<K, V, Long> objectFreq(K key) {
        notNullKey(key);
    ...
    public Command<K, V, List<Long>> hpersist(K key, K... fields) {
        notNullKey(key);
    ...
    public Command<K, V, Boolean> pexpire(K key, long milliseconds, ExpireArgs expireArgs) {
        notNullKey(key);
    ...
    public Command<K, V, Boolean> pexpireat(K key, long timestamp, ExpireArgs expireArgs) {
        notNullKey(key);
    ...
    public Command<K, V, Long> pexpiretime(K key) {
        notNullKey(key);
    ...
    public Command<K, V, Map<K, Long>> pubsubNumsub(K... channels) {
    ...
    public Command<K, V, List<K>> pubsubShardChannels() {
        CommandArgs<K, V> args = new CommandArgs<>(codec).add(SHARDCHANNELS);
        return createCommand(PUBSUB, new KeyListOutput<>(codec), args);
    }

    public Command<K, V, List<K>> pubsubShardChannels(K pattern) {
        LettuceAssert.notNull(pattern, "Pattern " + MUST_NOT_BE_NULL);
    ...
    public Command<K, V, Map<K, Long>> pubsubShardNumsub(K... shardChannels) {
    ...
    public Command<K, V, K> randomkey() {
    ...
    public Command<K, V, String> replicaof(String host, int port) {
        LettuceAssert.notNull(host, "Host " + MUST_NOT_BE_NULL);
        LettuceAssert.notEmpty(host, "Host " + MUST_NOT_BE_EMPTY);
    ...
    public Command<K, V, String> replicaofNoOne() {
        CommandArgs<K, V> args = new CommandArgs<>(codec).add(NO).add(ONE);
        return createCommand(REPLICAOF, new StatusOutput<>(codec), args);
    }

    public Command<K, V, String> restore(K key, byte[] value, RestoreArgs restoreArgs) {
        notNullKey(key);
        LettuceAssert.notNull(value, "Value " + MUST_NOT_BE_NULL);
    ...
    public Command<K, V, String> scriptFlush(FlushMode flushMode) {
        LettuceAssert.notNull(flushMode, "FlushMode " + MUST_NOT_BE_NULL);
    ...
    public Command<K, V, String> scriptLoad(byte[] script) {
        LettuceAssert.notNull(script, "Script " + MUST_NOT_BE_NULL);
    ...
    public Command<K, V, String> shutdown(ShutdownArgs shutdownArgs) {
    ...
    public Command<K, V, Long> sintercard(K... keys) {
        notEmpty(keys);
    ...
    public Command<K, V, Long> sintercard(long limit, K... keys) {
        notEmpty(keys);
    ...
    public Command<K, V, List<Boolean>> smismember(K key, V... members) {
        notNullKey(key);
        LettuceAssert.notNull(members, "Members " + MUST_NOT_BE_NULL);
        LettuceAssert.notEmpty(members, "Members " + MUST_NOT_BE_EMPTY);
    ...
    public Command<K, V, List<V>> sortReadOnly(K key) {
        notNullKey(key);

        return createCommand(SORT_RO, new ValueListOutput<>(codec), key);
    }

    public Command<K, V, List<V>> sortReadOnly(K key, SortArgs sortArgs) {
        notNullKey(key);
        LettuceAssert.notNull(sortArgs, "SortArgs " + MUST_NOT_BE_NULL);
    ...
    public Command<K, V, Long> sortReadOnly(ValueStreamingChannel<V> channel, K key) {
        notNullKey(key);
        notNull(channel);
    ...
    public Command<K, V, Long> sortReadOnly(ValueStreamingChannel<V> channel, K key, SortArgs sortArgs) {
        notNullKey(key);
        notNull(channel);
        LettuceAssert.notNull(sortArgs, "SortArgs " + MUST_NOT_BE_NULL);
    ...
    public Command<K, V, Long> spublish(K shardChannel, V message) {
    ...
    public Command<K, V, StringMatchResult> stralgoLcs(StrAlgoArgs strAlgoArgs) {
    ...
    public Command<K, V, Boolean> copy(K source, K destination) {
        LettuceAssert.notNull(source, "Source " + MUST_NOT_BE_NULL);
        LettuceAssert.notNull(destination, "Destination " + MUST_NOT_BE_NULL);
    ...
    public Command<K, V, List<StreamMessage<K, V>>> xclaim(K key, Consumer<K> consumer, XClaimArgs xClaimArgs,
        ...
        CommandArgs<K, V> args = new CommandArgs<>(codec).addKey(key).addKey(consumer.getGroup()).addKey(consumer.getName())
    ...
    public Command<K, V, List<PendingMessage>> xpending(K key, Consumer<K> consumer, Range<String> range, Limit limit) {
        ...
        CommandArgs<K, V> args = new CommandArgs<>(codec).addKey(key).addKey(consumer.getGroup());
    ...
    public Command<K, V, List<StreamMessage<K, V>>> xread(XReadArgs xReadArgs, StreamOffset<K>[] streams) {
        ...
        for (StreamOffset<K> stream : streams) {
            args.addKey(stream.getName());
        }

        for (StreamOffset<K> stream : streams) {
            args.add(stream.getOffset());
        }
    ...
    public Command<K, V, List<StreamMessage<K, V>>> xreadgroup(Consumer<K> consumer, XReadArgs xReadArgs,
        ...
        args.add("GROUP").add(encode(consumer.getGroup())).add(encode(consumer.getName()));
    ...
    public Command<K, V, KeyValue<K, ScoredValue<V>>> bzmpop(long timeout, ZPopArgs popArgs, K[] keys) {
        notEmpty(keys);
    ...
    public Command<K, V, KeyValue<K, ScoredValue<V>>> bzmpop(double timeout, ZPopArgs popArgs, K[] keys) {
        notEmpty(keys);
    ...
    public Command<K, V, KeyValue<K, List<ScoredValue<V>>>> bzmpop(long timeout, long count, ZPopArgs popArgs, K[] keys) {
        notEmpty(keys);
    ...
    public Command<K, V, KeyValue<K, List<ScoredValue<V>>>> bzmpop(double timeout, long count, ZPopArgs popArgs, K[] keys) {
        notEmpty(keys);
    ...
    public Command<K, V, KeyValue<K, ScoredValue<V>>> bzpopmin(long timeout, K... keys) {
        notEmpty(keys);
    ...
    public Command<K, V, KeyValue<K, ScoredValue<V>>> bzpopmin(double timeout, K... keys) {
        notEmpty(keys);
    ...
    public Command<K, V, KeyValue<K, ScoredValue<V>>> bzpopmax(long timeout, K... keys) {
        notEmpty(keys);
    ...
    public Command<K, V, KeyValue<K, ScoredValue<V>>> bzpopmax(double timeout, K... keys) {
        notEmpty(keys);
    ...
    public Command<K, V, List<V>> zdiff(K... keys) {
        notEmpty(keys);
    ...
    public Command<K, V, Long> zdiffstore(K destKey, K... srcKeys) {
        notNullKey(destKey);
        notEmpty(srcKeys);
    ...
    public Command<K, V, List<ScoredValue<V>>> zdiffWithScores(K... keys) {
        notEmpty(keys);
    ...
    public Command<K, V, Double> zincrby(K key, double amount, V member) {
        notNullKey(key);
    ...
    public Command<K, V, List<V>> zinter(K... keys) {
        notEmpty(keys);

        return zinter(new ZAggregateArgs(), keys);
    }

    public Command<K, V, List<V>> zinter(ZAggregateArgs aggregateArgs, K... keys) {
        notEmpty(keys);
    ...
    public Command<K, V, Long> zintercard(K... keys) {
        notEmpty(keys);
    ...
    public Command<K, V, Long> zintercard(long limit, K... keys) {
        notEmpty(keys);
    ...
    public Command<K, V, List<ScoredValue<V>>> zinterWithScores(K... keys) {
        notEmpty(keys);

        return zinterWithScores(new ZAggregateArgs(), keys);
    }

    public Command<K, V, List<ScoredValue<V>>> zinterWithScores(ZAggregateArgs aggregateArgs, K... keys) {
        notEmpty(keys);
    ...
    public Command<K, V, Long> zinterstore(K destination, ZAggregateArgs aggregateArgs, K... keys) {
        LettuceAssert.notNull(destination, "Destination " + MUST_NOT_BE_NULL);
    ...
    public Command<K, V, List<Double>> zmscore(K key, V... members) {
        notNullKey(key);
        notEmpty(members);
    ...
    public Command<K, V, KeyValue<K, ScoredValue<V>>> zmpop(ZPopArgs popArgs, K[] keys) {
        notEmpty(keys);
    ...
    public Command<K, V, KeyValue<K, List<ScoredValue<V>>>> zmpop(long count, ZPopArgs popArgs, K[] keys) {
        notEmpty(keys);
    ...
    public Command<K, V, ScoredValue<V>> zpopmin(K key) {
        notNullKey(key);
    ...
    public Command<K, V, List<ScoredValue<V>>> zpopmin(K key, long count) {
        notNullKey(key);
    ...
    public Command<K, V, ScoredValue<V>> zpopmax(K key) {
        notNullKey(key);
    ...
    public Command<K, V, List<ScoredValue<V>>> zpopmax(K key, long count) {
        notNullKey(key);
    ...
    public Command<K, V, V> zrandmember(K key) {
        notNullKey(key);
    ...
    public Command<K, V, List<V>> zrandmember(K key, long count) {
        notNullKey(key);
    ...
    public Command<K, V, ScoredValue<V>> zrandmemberWithScores(K key) {
        notNullKey(key);
    ...
    public Command<K, V, List<ScoredValue<V>>> zrandmemberWithScores(K key, long count) {
        notNullKey(key);
    ...
    public Command<K, V, Long> zrangebyscoreWithScores(ScoredValueStreamingChannel<V> channel, K key, Range<? extends Number> range,
                                                       Limit limit) {
        notNullKey(key);
        notNullRange(range);
        notNullLimit(limit);
    ...
    public Command<K, V, Long> zrangestore(K dstKey, K srcKey, Range<Long> range, boolean rev) {
        notNullKey(srcKey);
        notNullKey(dstKey);
        notNullRange(range);
    ...
    public Command<K, V, Long> zrangestorebylex(K dstKey, K srcKey, Range<? extends V> range, Limit limit, boolean rev) {
        notNullKey(srcKey);
        notNullKey(dstKey);
        notNullRange(range);
        notNullLimit(limit);
    ...
    public Command<K, V, Long> zrangestorebyscore(K dstKey, K srcKey, Range<? extends Number> range, Limit limit, boolean rev) {
        notNullKey(srcKey);
        notNullKey(dstKey);
        notNullRange(range);
        notNullLimit(limit);
    ...
    public Command<K, V, ScoredValue<Long>> zrankWithScore(K key, V member) {
        notNullKey(key);
    ...
    public Command<K, V, ScoredValue<Long>> zrevrankWithScore(K key, V member) {
        notNullKey(key);
    ...
    public Command<K, V, List<V>> zunion(K... keys) {
        notEmpty(keys);

        return zunion(new ZAggregateArgs(), keys);
    }

    public Command<K, V, List<V>> zunion(ZAggregateArgs aggregateArgs, K... keys) {
        notEmpty(keys);
    ...
    public Command<K, V, List<ScoredValue<V>>> zunionWithScores(K... keys) {
        notEmpty(keys);

        return zunionWithScores(new ZAggregateArgs(), keys);
    }

    public Command<K, V, List<ScoredValue<V>>> zunionWithScores(ZAggregateArgs aggregateArgs, K... keys) {
        notEmpty(keys);
    ...
    public Command<K, V, Long> zunionstore(K destination, ZAggregateArgs aggregateArgs, K... keys) {
        notEmpty(keys);
