...
public class HSetNXHandlerTest extends BaseRedisHandlerTest {

    @Test
    public void test_HSETNX() {
        RedisCommandBuilder<String, String> cmd = new RedisCommandBuilder<>(StringCodec.ASCII);
        ByteBuf buf = Unpooled.buffer();
        cmd.hsetnx("mykey", "field", "value").encode(buf);
    ...
    @Test
    public void test_HSETNX_already_exists() {
        RedisCommandBuilder<String, String> cmd = new RedisCommandBuilder<>(StringCodec.ASCII);
        {
            ByteBuf buf = Unpooled.buffer();
        ...
        ByteBuf buf = Unpooled.buffer();
        cmd.hsetnx("mykey", "field", "value-2").encode(buf);
        Object msg = runCommand(channel, buf);
        assertInstanceOf(IntegerRedisMessage.class, msg);
        IntegerRedisMessage actualMessage = (IntegerRedisMessage) msg;
