...
public class IncrByHandlerTest extends BaseRedisHandlerTest {

    @Test
    public void testINCRBY_KeyNotExists() {
        RedisCommandBuilder<String, String> cmd = new RedisCommandBuilder<>(StringCodec.ASCII);
        ByteBuf buf = Unpooled.buffer();
        cmd.incrby("mykey", 10).encode(buf);
    ...
    @Test
    public void testINCRBY_KeyExists() {
        RedisCommandBuilder<String, String> cmd = new RedisCommandBuilder<>(StringCodec.ASCII);
        {
            ByteBuf buf = Unpooled.buffer();
    ...
    @Test
    public void testINCRBY_InvalidIncrement() {
        RedisCommandBuilder<String, String> cmd = new RedisCommandBuilder<>(StringCodec.ASCII);
        {
            ByteBuf buf = Unpooled.buffer();
