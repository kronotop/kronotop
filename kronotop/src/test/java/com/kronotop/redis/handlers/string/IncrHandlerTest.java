...
public class IncrHandlerTest extends BaseRedisHandlerTest {

    @Test
    public void testINCR_KeyNotExists() {
        RedisCommandBuilder<String, String> cmd = new RedisCommandBuilder<>(StringCodec.ASCII);
        ByteBuf buf = Unpooled.buffer();
        cmd.incr("mykey").encode(buf);
    ...
    @Test
    public void testINCR_KeyExists() {
        RedisCommandBuilder<String, String> cmd = new RedisCommandBuilder<>(StringCodec.ASCII);
        {
            ByteBuf buf = Unpooled.buffer();
    ...
    @Test
    public void testINCR_InvalidIncrement() {
        RedisCommandBuilder<String, String> cmd = new RedisCommandBuilder<>(StringCodec.ASCII);
        {
            ByteBuf buf = Unpooled.buffer();
