...
import static com.kronotop.server.resp3.RedisCodecTestUtil.byteBufOf;
import static com.kronotop.server.resp3.RedisCodecTestUtil.bytesOf;
...
public class RedisDecoderTest {
    ...
    public void shouldDecodeEmptySet() {
        ...
        assertInstanceOf(SetRedisMessage.class, msg);
