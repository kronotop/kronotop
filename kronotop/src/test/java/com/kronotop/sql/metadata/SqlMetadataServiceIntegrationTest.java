...
public class SqlMetadataServiceIntegrationTest extends BaseHandlerTest {
    ...
    public void test_SqlMetadata_CREATE_TABLE() {
        ...
        ByteBuf buf = Unpooled.buffer();
        cmd.sql(SqlArgs.Builder.query("CREATE TABLE public.users (age INTEGER)")).encode(buf);
        channel.writeInbound(buf);
        Object response = channel.readOutbound();
    ...
    public void test_DROP_SCHEMA_successfully() {
        ...
        {
            ByteBuf buf = Unpooled.buffer();
            cmd.sql(SqlArgs.Builder.query("DROP SCHEMA public")).encode(buf);
            channel.writeInbound(buf);
            Object response = channel.readOutbound();
    ...
    public void test_DROP_TABLE_successfully() {
        ...
        {
            ByteBuf buf = Unpooled.buffer();
            cmd.sql(SqlArgs.Builder.query("CREATE TABLE users (age INTEGER)")).encode(buf);
            channel.writeInbound(buf);
            Object response = channel.readOutbound();
        ...
        {
            ByteBuf buf = Unpooled.buffer();
            cmd.sql(SqlArgs.Builder.query("DROP TABLE users")).encode(buf);
            channel.writeInbound(buf);
            Object response = channel.readOutbound();
    ...
    public void test_ALTER_TABLE_then_RENAME_TABLE() {
        ...
        {
            ByteBuf buf = Unpooled.buffer();
            cmd.sql(SqlArgs.Builder.query("ALTER TABLE public.users RENAME TO foobar")).encode(buf);
            channel.writeInbound(buf);
            Object response = channel.readOutbound();
    ...
    public void test_ALTER_TABLE_and_ADD_COLUMN() {
        ...
        {
            ByteBuf buf = Unpooled.buffer();
            cmd.sql(SqlArgs.Builder.query("ALTER TABLE public.users ADD COLUMN username VARCHAR(30)")).encode(buf);
            channel.writeInbound(buf);
            Object response = channel.readOutbound();
    ...
    public void test_ALTER_TABLE_and_DROP_COLUMN() {
        ...
        {
            ByteBuf buf = Unpooled.buffer();
            cmd.sql(SqlArgs.Builder.query("CREATE TABLE public.users (age INTEGER, username VARCHAR)")).encode(buf);
            channel.writeInbound(buf);
            Object response = channel.readOutbound();
        ...
        {
            ByteBuf buf = Unpooled.buffer();
            cmd.sql(SqlArgs.Builder.query("ALTER TABLE public.users DROP COLUMN username")).encode(buf);
            channel.writeInbound(buf);
            Object response = channel.readOutbound();
    ...
    public void test_ALTER_TABLE_and_RENAME_COLUMN() {
        ...
        {
            ByteBuf buf = Unpooled.buffer();
            cmd.sql(SqlArgs.Builder.query("ALTER TABLE public.users RENAME COLUMN username TO renamedcolumn")).encode(buf);
            channel.writeInbound(buf);
            Object response = channel.readOutbound();
    ...
    public void test_SqlMetadata_DROP_TABLE() {
        ...
        {
            ByteBuf buf = Unpooled.buffer();
            cmd.sql(SqlArgs.Builder.query("DROP TABLE public.users")).encode(buf);
            channel.writeInbound(buf);
            Object response = channel.readOutbound();
