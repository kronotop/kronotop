...
public class InsertIntoIntegrationTest extends BasePlanIntegrationTest {
    ...
    public void test_INSERT_INTO_returning() {
        ...
        cmd.sql(SqlArgs.Builder.queries("INSERT INTO users (age, username) VALUES (35, 'foobar')").returning("id", "username")).encode(buf);
        ...
        RedisMessage idValue = result.get("id");
    ...
    public void test_INSERT_INTO_then_COMMIT_RETURNING_FUTURES() {
...

        {
            ...
            FullBulkStringRedisMessage idValue = (FullBulkStringRedisMessage) result.get("$1");
