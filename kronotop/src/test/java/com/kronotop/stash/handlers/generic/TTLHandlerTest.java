...
class TTLHandlerTest extends BaseStashHandlerTest {
    ...
    void test_TTL() {
        RedisCommandBuilder<String, String> cmd = new RedisCommandBuilder<>(StringCodec.ASCII);
        {
            ...
            cmd.setex("mykey", 2, "myvalue").encode(buf);
