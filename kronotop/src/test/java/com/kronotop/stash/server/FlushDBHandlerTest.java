...
package com.kronotop.stash.server;
...
import com.kronotop.stash.storage.BaseStorageTest;
...
public class FlushDBHandlerTest extends BaseStorageTest {
    ...
    public void test_FLUSHDB() {
        ...
        {
            int shards = kronotopInstance.getContext().getConfig().getInt("stash.shards");
            for (int shardId = 0; shardId < shards; shardId++) {
                ...
                StashShard shard = stashService.findShard(shardId, ShardStatus.READWRITE);
