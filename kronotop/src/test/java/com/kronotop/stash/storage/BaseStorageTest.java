...
public class BaseStorageTest extends BaseTest {
    ...
    public void setup() throws UnknownHostException, InterruptedException {
        ...
        stashService = kronotopInstance.getContext().getService(StashService.NAME);
    ...
    protected boolean areAllShardsReadOnly() {
        ...
        for (int shardId = 0; shardId < shards; shardId++) {
            Route route = routingService.findRoute(ShardKind.STASH, shardId);
    ...
    protected void makeAllShardsReadOnly() {
        setShardStatus(ShardKind.STASH, ShardStatus.READONLY);
