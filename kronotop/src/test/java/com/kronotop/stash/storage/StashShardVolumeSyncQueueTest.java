...
import com.kronotop.stash.storage.impl.StashShardVolumeSyncQueue;
import com.kronotop.stash.storage.syncer.jobs.AppendStringJob;
import org.junit.jupiter.api.Test;

import static org.junit.jupiter.api.Assertions.assertThrows;

public class StashShardVolumeSyncQueueTest extends BaseStorageTest {

    @Test
    public void test_add() {
        StashShard shard = new OnHeapStashShardImpl(context, 0);
        makeAllShardsReadOnly();
        StashShardVolumeSyncQueue queue = new StashShardVolumeSyncQueue(shard);
